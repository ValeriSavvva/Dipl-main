...
const CreateEvent = (props) => {
  ...
  const [responseCriterii, setResponseCriterii] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      await Promise.allSettled([
        ...
        //   setStudentRoles(filterIncludeObjectsByNames(response[2].value.data.results, response[4].value.data.roles));
        //   setResponseStudentRoles(filterNotIncludeObjectsByNames(response[2].value.data.results, response[4].value.data.roles));
